...
const en = {
  ...
  monitorHint:
    'Hear yourself with a 1s delay (cuts echo). Prefer headphones — loud speakers can still feedback.',
  ...
  prehearSeekHint: 'Click or drag the waveform to play from that point.',
  ...
  updateDownloaded: 'Update {version} ready — reload to apply',
  updateApplying: 'Installing update — reloading…',
  updateApplyingDetail: 'BoysChanger is applying the update quietly. The app will reopen when it is done.',
  ...
  navMain: 'Main',
  homeTitle: 'BoysChanger',
  homeLede: 'Live dashboard — changer, voices, sounds, studio, and routing in one place.',
  homeMore: 'More',
  homeChangerOn: 'Changer ON',
  homeChangerOff: 'Start changer',
  homeVoicesDesc: 'Tap a voice to apply it now.',
  homeSoundsDesc: 'Play a sound through the virtual cable.',
  homeStudioDesc: 'Quick character and FX — open Studio for the full rack.',
  homeSettingsDesc: 'Mic, virtual cable, and Telegram routing.',
  voicesTitle: 'Voice library',
  voicesBuiltin: 'Built-in',
  voicesMine: 'My voices',
  voicesAll: 'All',
  voicesSearch: 'Search voices…',
  voicesEmptyMine: 'No saved voices yet — open Studio and hit Save.',
  voicesFree: 'Built-in',
  voicesDelete: 'Delete',
  voicesCloudSoon: 'Built-in + local saves · cloud sync coming soon',
  studioTitle: 'Voice Studio',
  studioFree: 'Craft and keep voices on this device',
  studioSave: 'Save voice',
  studioSaveAs: 'Save as…',
  studioNamePlaceholder: 'Name your voice',
  studioSaved: 'Voice saved locally',
  studioActive: 'Active voice',
  studioPickVoice: 'Pick a voice',
  dockHearMyself: 'Hear myself',
  dockEffects: 'FX',
  dockStudio: 'Studio',
  dockStudioHint: 'Open Voice Studio — race, gender, age, timbre, and effects',
  searchApp: 'Search BoysChanger',
  searchClear: 'Clear search',
  profileTitle: 'Your profile',
  profileLede: 'Tune a live 3D avatar like the dashboard hero — cloud sync comes later.',
  profileName: 'Display name',
  profileNamePlaceholder: 'How should we call you?',
  profileLocalOnly: 'Saved on this device only',
  profilePremade: '3D avatar',
  profileUpload: 'Upload image',
  profileUploadHint: 'PNG, JPG, WEBP or GIF up to 4 MB.',
  profileUploadReplace: 'Choose another image',
  profileUploadNeed: 'Pick an image first, or switch to premade skins.',
  profileSkin: 'Color',
  profileForm: 'Form',
  profileHair: 'Form',
  profileEyes: 'Eyes',
  profileMood: 'Motion',
  profileAccessory: 'Aura',
  profileHair_none: 'None',
  profileHair_short: 'Short',
  profileHair_wavy: 'Wavy',
  profileHair_spike: 'Spike',
  profileHair_bun: 'Bun',
  profileHair_cap: 'Cap',
  profileForm_logo: 'Mark',
  profileForm_orb: 'Orb',
  profileForm_crystal: 'Shard',
  profileForm_ring: 'Rings',
  profileForm_mic: 'Mic',
  profileForm_speaker: 'Speaker',
  profileForm_flask: 'Flask',
  profileForm_gear: 'Gear',
  profileForm_wave: 'Wave',
  profileEyes_round: 'Round',
  profileEyes_cat: 'Cat',
  profileEyes_star: 'Star',
  profileEyes_shades: 'Shades',
  profileMood_smile: 'Lively',
  profileMood_cool: 'Steady',
  profileMood_laugh: 'Wild',
  profileMood_neutral: 'Calm',
  profileAcc_none: 'None',
  profileAcc_headset: 'Rings',
  profileAcc_earring: 'Gold sparks',
  profileAcc_bow: 'Pink flare',
  profileAcc_spark: 'Sparks',
  profileSave: 'Save profile',
  profileCancel: 'Cancel',
  profileOpen: 'Edit profile',
} as const;
...
const zh: Record<MessageKey, string> = {
  ...
  stopEngine: '停止引擎',
  monitorLocally: '本地监听',
  monitorHint: '以约 1 秒延迟听自己（减少回授）。请优先使用耳机——扬声器过响仍可能啸叫。',
  voiceCharacter: '声音角色',
  race: '种族',
  gender: '性别',
  age: '年龄',
  ...
  prehearSeekHint: '点击或拖动波形即可从该位置播放。',
  ...
  updateDownloaded: '更新 {version} 已就绪 — 重新加载以应用',
  updateApplying: '正在安装更新 — 即将重新加载…',
  updateApplyingDetail: 'BoysChanger 正在静默安装更新，完成后会自动重新打开。',
  updateReload: '重新加载以更新',
  updateLatest: '已是最新版本',
  updateError: '检查更新失败',
  ...
  navMain: '主页',
  homeTitle: 'BoysChanger',
  homeLede: '实时面板 — 变声、音色、音效、工作室与路由集中一处。',
  homeMore: '更多',
  homeChangerOn: '变声已开',
  homeChangerOff: '启动变声',
  homeVoicesDesc: '点选音色立即应用。',
  homeSoundsDesc: '通过虚拟声卡播放音效。',
  homeStudioDesc: '快速角色与效果 — 打开工作室查看完整机架。',
  homeSettingsDesc: '麦克风、虚拟声卡与 Telegram 路由。',
  voicesTitle: '音色库',
  voicesBuiltin: '内置',
  voicesMine: '我的',
  voicesAll: '全部',
  voicesSearch: '搜索音色…',
  voicesEmptyMine: '还没有保存的音色 — 打开工作室并点击保存。',
  voicesFree: '内置',
  voicesDelete: '删除',
  voicesCloudSoon: '内置 + 本地保存 · 云同步即将推出',
  studioTitle: '音色工作室',
  studioFree: '在本机创建并保存音色',
  studioSave: '保存音色',
  studioSaveAs: '另存为…',
  studioNamePlaceholder: '给音色起名',
  studioSaved: '已保存到本地',
  studioActive: '当前音色',
  studioPickVoice: '选择音色',
  dockHearMyself: '听自己',
  dockEffects: '特效',
  dockStudio: '工作室',
  dockStudioHint: '打开音色工作室 — 种族、性别、年龄、音色与效果',
  searchApp: '搜索 BoysChanger',
  searchClear: '清除搜索',
  profileTitle: '你的资料',
  profileLede: '调一个与仪表盘同风格的实时 3D 头像 — 云同步稍后上线。',
  profileName: '显示名',
  profileNamePlaceholder: '怎么称呼你？',
  profileLocalOnly: '仅保存在本机',
  profilePremade: '3D 头像',
  profileUpload: '上传图片',
  profileUploadHint: 'PNG / JPG / WEBP / GIF，最大 4 MB。',
  profileUploadReplace: '换一张图',
  profileUploadNeed: '请先选图，或切回预设皮肤。',
  profileSkin: '颜色',
  profileForm: '形态',
  profileHair: '形态',
  profileEyes: '眼睛',
  ...
  profileAccessory: '光环',
  profileHair_none: '无',
  profileHair_short: '短发',
  profileHair_wavy: '波浪',
  profileHair_spike: '刺头',
  profileHair_bun: '丸子',
  profileHair_cap: '帽子',
  profileForm_logo: '标志',
  profileForm_orb: '球体',
  profileForm_crystal: '碎片',
  profileForm_ring: '环',
  profileForm_mic: '麦克风',
  profileForm_speaker: '扬声器',
  profileForm_flask: '烧瓶',
  profileForm_gear: '齿轮',
  profileForm_wave: '波形',
  profileEyes_round: '圆眼',
  profileEyes_cat: '猫眼',
  profileEyes_star: '星星',
  profileEyes_shades: '墨镜',
  profileMood_smile: '活泼',
  profileMood_cool: '稳',
  profileMood_laugh: '狂',
  profileMood_neutral: '静',
  profileAcc_none: '无',
  profileAcc_headset: '光环',
  profileAcc_earring: '金火花',
  profileAcc_bow: '粉光',
  profileAcc_spark: '火花',
  profileSave: '保存资料',
  profileCancel: '取消',
...
const ru: Record<MessageKey, string> = {
  ...
  monitorHint:
    'Слушайте себя с задержкой ~1 с (меньше эха). Лучше наушники — громкие динамики всё ещё могут дать обратную связь.',
  ...
  prehearSeekHint: 'Нажмите или протяните по эквалайзеру, чтобы играть с этого места.',
  ...
  updateDownloaded: 'Обновление {version} готово — перезагрузите, чтобы применить',
  updateApplying: 'Установка обновления — перезагрузка…',
  updateApplyingDetail: 'BoysChanger тихо устанавливает обновление. Приложение откроется снова, когда всё будет готово.',
  ...
  navMain: 'Главная',
  homeTitle: 'BoysChanger',
  homeLede: 'Живая панель — чейнджер, голоса, звуки, студия и маршрутизация в одном месте.',
  homeMore: 'Ещё',
  homeChangerOn: 'Чейнджер ВКЛ',
  homeChangerOff: 'Запустить чейнджер',
  homeVoicesDesc: 'Нажмите голос, чтобы применить сразу.',
  homeSoundsDesc: 'Проиграть звук через виртуальный кабель.',
  homeStudioDesc: 'Быстрый характер и FX — полная стойка в Студии.',
  homeSettingsDesc: 'Микрофон, кабель и маршрутизация Telegram.',
  voicesTitle: 'Библиотека голосов',
  voicesBuiltin: 'Встроенные',
  voicesMine: 'Мои',
  voicesAll: 'Все',
  voicesSearch: 'Поиск голосов…',
  voicesEmptyMine: 'Пока нет сохранённых — откройте Студию и нажмите Сохранить.',
  voicesFree: 'Встроенный',
  voicesDelete: 'Удалить',
  voicesCloudSoon: 'Встроенные + локальные · облако скоро',
  studioTitle: 'Голосовая студия',
  studioFree: 'Создавайте и храните голоса на этом устройстве',
  studioSave: 'Сохранить голос',
  studioSaveAs: 'Сохранить как…',
  studioNamePlaceholder: 'Название голоса',
  studioSaved: 'Голос сохранён локально',
  studioActive: 'Активный голос',
  studioPickVoice: 'Выбрать голос',
  dockHearMyself: 'Слушать себя',
  dockEffects: 'FX',
  dockStudio: 'Студия',
  dockStudioHint: 'Открыть голосовую студию — раса, пол, возраст, тембр и эффекты',
  searchApp: 'Поиск BoysChanger',
  searchClear: 'Очистить поиск',
  profileTitle: 'Ваш профиль',
  profileLede: 'Настройте живой 3D-аватар в стиле главного экрана — облако позже.',
  profileName: 'Имя',
  profileNamePlaceholder: 'Как вас называть?',
  profileLocalOnly: 'Только на этом устройстве',
  profilePremade: '3D аватар',
  profileUpload: 'Загрузить фото',
  profileUploadHint: 'PNG, JPG, WEBP или GIF до 4 МБ.',
  profileUploadReplace: 'Выбрать другое фото',
  profileUploadNeed: 'Сначала выберите фото или вернитесь к готовым скинам.',
  profileSkin: 'Цвет',
  profileForm: 'Форма',
  profileHair: 'Форма',
  profileEyes: 'Глаза',
  profileMood: 'Движение',
  profileAccessory: 'Аура',
  profileHair_none: 'Нет',
  profileHair_short: 'Короткие',
  profileHair_wavy: 'Волны',
  profileHair_spike: 'Шипы',
  profileHair_bun: 'Пучок',
  profileHair_cap: 'Кепка',
  profileForm_logo: 'Знак',
  profileForm_orb: 'Сфера',
  profileForm_crystal: 'Кристалл',
  profileForm_ring: 'Кольца',
  profileForm_mic: 'Микрофон',
  profileForm_speaker: 'Динамик',
  profileForm_flask: 'Колба',
  profileForm_gear: 'Шестерня',
  profileForm_wave: 'Волна',
  profileEyes_round: 'Круглые',
  profileEyes_cat: 'Кошачьи',
  profileEyes_star: 'Звёзды',
  profileEyes_shades: 'Очки',
  profileMood_smile: 'Живое',
  profileMood_cool: 'Ровное',
  profileMood_laugh: 'Дикое',
  profileMood_neutral: 'Спокойное',
  profileAcc_none: 'Нет',
  profileAcc_headset: 'Кольца',
  profileAcc_earring: 'Золотые искры',
  profileAcc_bow: 'Розовый блик',
  profileAcc_spark: 'Искры',
  profileSave: 'Сохранить',
  profileCancel: 'Отмена',
  profileOpen: 'Редактировать профиль',
};
