...
const en = {
  ...
  homeLede: 'Pick a section to get started — or open More for the full view.',
  homeMore: 'More',
  homeVoicesDesc: 'Browse built-in characters and voices you saved locally.',
  homeSoundsDesc: 'Drop sound memes into chat through the virtual cable.',
  homeStudioDesc: 'Shape race, gender, age, timbre, and effects — then save.',
  homeSettingsDesc: 'Mic, virtual cable, Telegram setup, and system routing.',
...
const zh: Record<MessageKey, string> = {
  ...
  navMain: '主页',
  homeTitle: 'BoysChanger',
  homeLede: '选择一个分区开始 — 或点击「更多」打开完整界面。',
  homeMore: '更多',
  homeVoicesDesc: '浏览内置角色以及你本地保存的音色。',
  homeSoundsDesc: '通过虚拟声卡把梗声丢进聊天。',
  homeStudioDesc: '调节种族、性别、年龄、音色与特效 — 然后保存。',
  homeSettingsDesc: '麦克风、虚拟声卡、Telegram 设置与系统路由。',
  voicesTitle: '音色库',
  voicesBuiltin: '内置',
  voicesMine: '我的',
  voicesAll: '全部',
...
const ru: Record<MessageKey, string> = {
  ...
  navMain: 'Главная',
  homeTitle: 'BoysChanger',
  homeLede: 'Выберите раздел — или нажмите «Ещё», чтобы открыть полный экран.',
  homeMore: 'Ещё',
  homeVoicesDesc: 'Встроенные персонажи и голоса, сохранённые локально.',
  homeSoundsDesc: 'Мемы и звуки в чат через виртуальный кабель.',
  homeStudioDesc: 'Раса, пол, возраст, тембр и эффекты — затем сохраните.',
  homeSettingsDesc: 'Микрофон, кабель, Telegram и системная маршрутизация.',
