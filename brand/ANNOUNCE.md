...
BoysChanger — системный войс-чейнджер для Windows и macOS.

Меняйте голос (раса, пол, возраст, тембр), накладывайте эффекты, слушайте последние 11 секунд и отправляйте результат как системный микрофон.
...
BoysChanger — 适用于 Windows 与 macOS 的系统级变声器。

调节种族、性别、年龄与音色，叠加效果，试听最近 11 秒，并将结果设为系统麦克风。

官网与下载：https://hyperlinksspace.github.io/BoysChanger/
